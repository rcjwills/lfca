...
Temperature data set (Smith et al. 2008) and can be downloaded here: https://iacweb.ethz.ch/staff/rjnglin/data/ERSST_1900_2016.mat. All use of this data should reference the appropriate publication:
...
The data file for the bivariate example includes data from the AVISO monthly-mean sea-surface height anomaly data set (https://www.aviso.altimetry.fr/en/index.php?id=1526) and can be downloaded here: https://iacweb.ethz.ch/staff/rjnglin/data/AVISO_1993_2016.mat. All use of this data should use the citation: "This product was processed by SSALTO/DUACS and distributed by AVISO+ (https://www.aviso.altimetry.fr) with support from CNES”.
